...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name='variableMetadataPrefix'
		select="/oai:OAI-PMH/oai:request/@metadataPrefix" />
	<xsl:variable name='metadataPrefix'><xsl:choose>
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<p class="intro">
					You are viewing an HTML version of the XML OAI response. To see the
					underlying XML use your web browsers view source option. More
					information about this XSLT is at the
					<a href="#moreinfo">bottom of the page</a>
					.
				</p>
				...
				<p>
					An XSLT file has converted the
					<a href="http://www.openarchives.org">OAI-PMH 2.0</a>
					responses into XHTML which looks nice in a browser which supports
					XSLT such as Mozilla, Firebird and Internet Explorer. The XSLT file
					was created by
					<a href="http://www.ecs.soton.ac.uk/people/cjg">Christopher Gutteridge</a>
					at the University of Southampton as part of the
					<a href="http://software.eprints.org">GNU EPrints system</a>
					, and is freely redistributable under the
					<a href="http://www.gnu.org">GPL</a>
					.
				</p>
				<p>If you want to use the XSL file on your own OAI interface you may
					but due to the way XSLT works you must install the XSL file on the
					same server as the OAI script, you can't just link to this copy.</p>
				<p>
					For more information or to download the XSL file please see the
					<a href="http://software.eprints.org/xslt.php">OAI to XHTML XSLT homepage</a>
					.
				</p>
	...
	<xsl:template name="quicklinks">
		<ul class="quicklinks">
			...
			<li>
				<a href="?verb=ListIdentifiers&amp;metadataPrefix={$metadataPrefix}">ListIdentifiers</a>
			</li>
		</ul>
	</xsl:template>
		...
		<table class="values">
			<tr>
				...
				<td class="value">
					...
					<xsl:text> </xsl:text>
					<a class="link"
						href="?verb=ListMetadataFormats&amp;identifier={oai:identifier}">formats</a>
				</td>
			</tr>
			<tr>
	...
	<xsl:template match="oai:setSpec">
		<tr>
			...
			<td class="value">
				...
				<xsl:text> </xsl:text>
				<a class="link"
					href="?verb=ListIdentifiers&amp;metadataPrefix={$metadataPrefix}&amp;set={.}">Identifiers</a>
				<xsl:text> </xsl:text>
				<a class="link"
					href="?verb=ListRecords&amp;metadataPrefix={$metadataPrefix}&amp;set={.}">Records</a>
			</td>
		</tr>
	</xsl:template>
		...
		<table class="values">
			<tr>
				...
				<td class="value">
					...
					<xsl:text> </xsl:text>
					<a class="link"
						href="?verb={/oai:OAI-PMH/oai:request/@verb}&amp;resumptionToken={.}">Resume</a>
				</td>
			</tr>
		</table>
	</xsl:template>
