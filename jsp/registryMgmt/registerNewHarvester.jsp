...
<div id="ctr" align="center">
	<div class="install">
		...
		<div id="right">
			...
			<h1>Introduce the information for the new harvester</h1>
			...
			<div class="install-form">
  	   			<div class="form-block">
  	     			...
  	     			<tr>
  		  			...
  		  			<tr>
  		    			<td>URL :<br/><input class="inputbox" style="width:100%;" type="text" class="inputboxadd" name="url" value=""/></td>
  		    		</tr>
  		    		<tr>
  		    			<td>User :<br/><input class="inputbox" style="width:100%;" type="text" class="inputboxadd" name="user" value=""/></td>
  		    		</tr>
  		    		<tr>
  		    			<td>Password :<br/><input class="inputbox" style="width:100%;" type="text" class="inputboxadd" name="pass" value=""/></td>
  		    		</tr>    		
		  	        </table>
  				</div>
			</div>
