...
public class SPIDevImplementation extends SPIDevSkeleton {
    ...
    public void submitResource(SubmitResource submitResource)
        ...
        try {
            ...
            /*boolean success = */InsertContentFactory.insertContent(submitResource.getGlobalIdentifier(), submitResource.getBinaryData().getBase64Binary(), submitResource.getFileName(), submitResource.getFileType());
//            if (!success) {
