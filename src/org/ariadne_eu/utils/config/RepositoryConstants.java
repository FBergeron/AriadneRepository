...
public class RepositoryConstants {
	...
	public static final String MD_LUCENE_INDEXDIR = "mdstore.lucene.indexdir";
	public static final String MD_LUCENE_HANDLER = "mdstore.lucene.handler";
	public static final String MD_LUCENE_ANALYZER = "mdstore.lucene.analyzer";
	public static final String MD_LUCENE_REINDEX = "mdstore.lucene.reindex";
	public static final String MD_LUCENE_REINDEX_MAXQRYRESULTS = "mdstore.lucene.reindex.maxqueryresults";
	public static final String MD_LUCENE_ANALYZER_MACE_CLASSIFICATION = "mdstore.lucene.analyzer.mace.classification";
	public static final String MD_LUCENE_XPATHQRY_ID = "mdstore.lucene.xpathquery.identifier";
	...
	public static final String MD_SOLR_INSTANCEDIR = "mdstore.solr.instancedir";
	public static final String MD_SOLR_FACETFIELD = "mdstore.solr.facetfield";
	...
	public static final String REPO_DATADIR = "repository.dataDir";
