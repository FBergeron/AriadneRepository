...
public class ResultDelegateLatestPublication implements IndexSearchDelegate {
	private static Logger log = Logger.getLogger(ResultDelegateLatestPublication.class);

    private int start;
    private int max;

    public ResultDelegateLatestPublication(int start, int max) {
        this.start = start;
        this.max = max;
    }
