...
public class OracleLomRecordFactory extends AbstractRecordFactory{
	protected String column_id = "";
	protected String column_datestamp = "";

	public OracleLomRecordFactory(Properties properties)	throws IllegalArgumentException {
		super(properties);
		String catalogClassName = "OracleLomCatalog";
